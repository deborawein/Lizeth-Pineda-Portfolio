/** Portfolio categories and media — edit content here without touching UI code. */
  ...
  },
  {
    ...
    images: [
      ...
      },
      {
        ...
        aspectRatio: '3 / 4',
        slides: [
          { src: '/photos/a.jpg', alt: 'Lifestyle capture in natural light', caption: 'Set A — lifestyle documentation.' },
          { src: '/photos/b.jpg', alt: 'Studio portrait with soft lighting', caption: 'Set B — portrait direction.' },
          { src: '/photos/c.jpg', alt: 'Urban street scene with contrast', caption: 'Set C — street photography.' },
          { src: '/photos/d.jpg', alt: 'Editorial-style composition with props', caption: 'Set D — editorial set piece.' },
          { src: '/photos/e.jpg', alt: 'Warm film-inspired scene', caption: 'Set E — warm tone study.' },
          { src: '/photos/f.jpg', alt: 'Minimal product shot with bold typography', caption: 'Set F — product styling.' },
          { src: '/photos/g.jpg', alt: 'Outdoor environmental portrait', caption: 'Set G — lifestyle documentation.' },
          { src: '/photos/h.jpg', alt: 'Night scene with neon lights', caption: 'Set H — night-time mood exploration.' },
          { src: '/photos/i.jpg', alt: 'Detail shot focusing on texture', caption: 'Set I — texture study for brand kit.' },
          { src: '/photos/j.jpg', alt: 'Event crowd moment', caption: 'Set J — energy from live events.' },
          { src: '/photos/k.jpg', alt: 'Creative composition with reflections', caption: 'Set K — reflective composition.' }
        ]
      }
    ]
  },
